...
export const dynamicParams = {
  ...
  hajj: [
    { id: 'hajj-1', template: 'hajj_package' },
    { id: 'hajj-2', template: 'hajj_package' },
    { id: 'hajj-3', template: 'hajj_package' },
  ],
  general: [
    { slug: 'about-us' },
    ...
    { slug: 'ramzan-umrah-packages', template: 'single_umrah' },
    { slug: 'london-umrah-packages', template: 'single_umrah' },
